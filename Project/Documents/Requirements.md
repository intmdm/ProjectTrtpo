...
Приложение позволяет одним нажатием начать/остановить отсчет времени. Диаграмма которая удобно покажет кужа ушло ваще время. 
...
Приложение обрабатывает данные которые вводит пользователь. 
...
| Функция | Требования | 
|:---|:---|
| Загрузка задачь | После входа пользователя в приложение отображается список задачь с таймерами |
...
1. Нету возможности просмотра данных в опеделенный день;
...
Приложение не предоставляет возможность защиты информации от других пользователей.
